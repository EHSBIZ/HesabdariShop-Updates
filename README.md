...
**HesabdariShop** یک نرم‌افزار دسکتاپ برای مدیریت حسابداری و امور مالی فروشگاه‌هاست که با هدف ساده‌سازی عملیات روزمره طراحی شده است.
...
HesabdariShop دارای قابلیت بررسی نسخه‌های جدید است.
